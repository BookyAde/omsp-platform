  ...
  const { error: formErr } = await admin
    ...
    .update({
      ...
      approval_email_enabled:
        formData.approval_email_enabled ?? true,

      approval_email_subject:
        formData.approval_email_subject ?? null,

      approval_email_message:
        formData.approval_email_message ?? null,

      rejection_email_enabled:
        formData.rejection_email_enabled ?? true,

      rejection_email_subject:
        formData.rejection_email_subject ?? null,

      rejection_email_message:
        formData.rejection_email_message ?? null,

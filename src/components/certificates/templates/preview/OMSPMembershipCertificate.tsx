...
function getQrPosition(position?: string) {
  if (position === "top-left") return "absolute left-8 top-8";
  if (position === "top-right") return "absolute right-8 top-8";
  if (position === "bottom-left") return "absolute bottom-8 left-8";
...
export default function OMSPMembershipCertificate({
  ...
  return (
    <div className="w-full overflow-x-auto rounded-2xl bg-slate-100 p-4">
      <div className="relative mx-auto aspect-[1.414/1] w-full max-w-5xl overflow-hidden rounded-xl border-[6px] border-cyan-950 bg-white shadow-2xl">
        <div className="absolute inset-0 bg-gradient-to-br from-white via-cyan-50 to-slate-100" />

        <div className="absolute left-0 top-0 h-full w-24 bg-gradient-to-b from-cyan-950 via-cyan-800 to-teal-700" />
        <div className="absolute left-24 top-0 h-full w-px bg-cyan-900/20" />
        <div className="absolute right-0 top-0 h-full w-8 bg-cyan-950" />

        <div className="absolute inset-6 rounded-lg border border-cyan-900/15" />
        <div className="absolute -bottom-24 -right-24 h-80 w-80 rounded-full bg-cyan-300/20 blur-2xl" />
        <div className="absolute -top-28 left-16 h-80 w-80 rounded-full bg-teal-300/20 blur-2xl" />
        ...
        <div className="relative z-10 flex h-full">
          <aside className="flex w-24 flex-col items-center justify-between py-9 text-white">
          ...
          <div className="flex flex-1 flex-col px-12 py-9 text-center text-slate-900">
            <div className="flex items-start justify-between">
              <div className="text-left">
                <p className="text-[10px] font-semibold uppercase tracking-[0.28em] text-cyan-800">
                  {organizationName}
                </p>
            ...
            <div className="mx-auto mt-10 max-w-3xl">
              ...
              <h2 className="mt-4 font-serif text-5xl font-bold text-slate-950">
                {recipientName}
              </h2>

              <div className="mx-auto mt-4 h-px w-80 bg-cyan-800/40" />

              <p className="mx-auto mt-5 max-h-24 max-w-2xl overflow-hidden text-sm leading-6 text-slate-600">
                {description}
              </p>
            </div>

            <div
              className={`mx-auto mt-8 grid w-full max-w-3xl gap-3 text-left text-xs ${
                expiryDate ? "grid-cols-4" : "grid-cols-3"
              }`}
            >
              <div className="rounded-xl border border-cyan-900/10 bg-white/75 p-3 shadow-sm">
            ...
            <div className="mt-auto grid w-full grid-cols-3 items-end gap-6 pt-6">

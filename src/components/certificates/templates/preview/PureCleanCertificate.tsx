  ...
  return (
    <div className="w-full overflow-x-auto rounded-2xl bg-slate-100 p-4">
      <div className="relative mx-auto aspect-[1.414/1] w-full max-w-5xl overflow-hidden rounded-xl border border-slate-200 bg-white shadow-xl">
        ...
        {qrPosition !== "hidden" && (
          <div className={getQrPosition(qrPosition)}>
            {qrCodeUrl ? (
              ...
              <div className="flex h-20 w-20 items-center justify-center rounded-md border border-slate-200 bg-white text-[10px] text-slate-400">
                QR
              </div>
            )}
          </div>
        ...
        <div className="relative z-10 flex h-full flex-col items-center justify-between px-16 py-14 text-center">
          ...
          <div className="max-w-3xl">
            ...
            <h2 className="mt-5 font-serif text-5xl font-bold text-slate-900">
              {recipientName}
            </h2>
          ...
          <div className="grid w-full grid-cols-3 items-end gap-6">
            ...
            <div className="text-center">
              ...
              <div className="mx-auto mb-2 mt-1 h-px w-44 bg-slate-700" />
          ...
          {verificationUrl && (
            <p className="absolute bottom-4 text-[10px] tracking-wide text-slate-400">

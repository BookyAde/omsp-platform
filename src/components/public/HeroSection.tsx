  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden bg-hero-gradient">
      <div className="absolute inset-0 pointer-events-none" aria-hidden="true">
        <div className="absolute top-1/3 left-1/4 w-[600px] h-[600px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-teal-500/8 blur-[120px]" />
        <div className="absolute top-1/2 right-1/4 w-[500px] h-[500px] -translate-y-1/2 rounded-full bg-ocean-400/10 blur-[100px]" />
      ...
      <div className="section-container relative z-10 pt-28 pb-20 lg:pt-36 lg:pb-28">
        <div className="max-w-4xl">
          <span
            className="section-eyebrow animate-fade-up"
          ...
          <h1
            className="font-display text-5xl md:text-6xl lg:text-7xl font-semibold leading-[1.12] tracking-[-0.015em] text-white/95 animate-fade-up"
          ...
          <p
            className="mt-6 text-slate-300/90 text-lg md:text-xl leading-8 max-w-2xl animate-fade-up"
            style={{ animationDelay: "0.28s", animationFillMode: "both" }}
          >
            OMSP connects marine science students and professionals across
            institutions, providing structured pathways to skills, careers, and
            community impact in ocean sustainability.
          </p>
          ...
          >
            {[
              ...
              <div key={label} className="flex flex-col">
                ...
                <span className="text-slate-400/90 text-xs mt-1 uppercase tracking-[0.16em] font-medium">
                  {label}
                </span>
              </div>
            ))}
      ...
      <div
        className="absolute right-0 top-1/2 -translate-y-1/2 w-[420px] h-[420px] opacity-10 pointer-events-none hidden xl:block"
        aria-hidden="true"
      >
